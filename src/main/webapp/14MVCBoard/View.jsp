...
<table border="1" width="90%">
	...
	<tr>
		...
		<td>다운로드수</td> <td>${ dto.downcnt }</td>
	</tr>
	<tr>
		<td colspan="4" align="center">
			<button type="button" onclick="location.href='../mvcboard/pw.do?mode=edit&idx=${ param.idx }';">수정하기</button>
			<button tyep="button" onclick="location.href='../mvcboard/pw.do?mode=delete&idx=${ param.idx }';">삭제하기</button>
